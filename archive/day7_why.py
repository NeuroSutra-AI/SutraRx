...
# WHY explanations — the Kāraka reasoning layer
KARAKA_WHY = {
    ("warfarin", "aspirin"): {
    ...
    ("warfarin", "ibuprofen"): {
        ...
        "karaka": "Ibuprofen (Kartā) acts on plasma proteins (Karaṇā) to displace warfarin (Karma) — increasing free warfarin concentration in blood.",
...
def shield_with_why(drug_a, drug_b):
    ...
    if flagged:
        ...
        if why:
            ...
            print(f"🔬 WHY: Interaction detected but detailed reasoning")
            print(f"   not yet available. Recommend pharmacist review.")
...
# Test
shield_with_why("warfarin", "aspirin")
shield_with_why("aspirin", "ibuprofen")
shield_with_why("warfarin", "heparin")
shield_with_why("warfarin", "ibuprofen")